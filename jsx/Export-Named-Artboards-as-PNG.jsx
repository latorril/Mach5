...
function nyt_show_png_dialog() {
    ...
    nyt_png_dlg.btnPnl.okBtn.onClick = function() { nyt_png_prefix = prefixEt.text; nyt_run_export( num_to_export, png_ppi);   };

    nyt_png_dlg.show();
}

function nyt_run_export( num_to_export, png_ppi ) {
